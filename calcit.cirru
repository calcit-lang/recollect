...
{} (:about "|Machine-generated snapshot. Do not edit directly — changes will be overwritten. Use `calcit query` to inspect and `calcit edit`/`calcit tree` to modify. Run `calcit docs agents --contract` before mutations; use `--full` for first orientation or changed contract digest. Manual edits must follow format and schema conventions, then run `calcit edit format`.") (:package |recollect)
  :entries $ {}
    ...
    'recollect.app.main $ %{} 'FileEntry
      :defs $ {}
        ...
        'next-client-store $ %{} 'CodeEntry (:doc |)
          :code $ quote
            defn next-client-store (changes)
        ...
        'next-data-twig $ %{} 'CodeEntry (:doc |)
          :code $ quote
            defn next-data-twig () $ assert-type (twig-container @*store)
              :: 'Map 'Tag $ :: 'Map 'Dynamic 'Dynamic
          :examples $ []
          :schema $ :: 'Fn
            {}
        ...
        'twig-container $ %{} 'CodeEntry (:doc |)
          :code $ quote
            defn twig-container (store)
              &merge store $ {}
                :card $ memo-twig-by :card twig-card (&map:get store :user) (&map:get store :date)
          :examples $ []
          :schema $ :: 'Fn
            {} (:return 'Dynamic)
              :args $ [] 'Dynamic
              ...
              match op
                ...
                (:date)
                  let
                    ...
                    &map:assoc store :date $ &map:assoc date :month
                      inc $ assert-type
    ...
    'recollect.diff $ %{} 'FileEntry
      :defs $ {}
        ...
        'set-difference-dynamic $ %{} 'CodeEntry (:doc |)
          :code $ quote
            defn set-difference-dynamic (a b)
              let
                  xs $ &set:to-list a
                &list:to-set $ loop
                    i 0
        ...
        'set-difference-iter $ %{} 'CodeEntry (:doc |)
          :code $ quote
            defn set-difference-iter (xs a acc)
              if (empty? xs) acc $ let
                  x $ &list:first xs
        ...
        'finish-twig-frame! $ %{} 'CodeEntry (:doc "|Finish the current twig memo frame, retaining only entries touched during that frame.")
          :code $ quote
            defn finish-twig-frame! ()
              if @*twig-frame-active? $ reset! *twig-call-cache
                assert-type @*twig-frame-cache $ :: 'Map 'Dynamic 'Dynamic
              ...
              loop
                ...
                if
                  ...
                  , total $ let
                    ...
                    recur (inc i)
                      + total $ &list:count
                        &map:to-list $ assert-type (&list:last pair) (:: 'Map 'Dynamic 'Dynamic)
          :examples $ []
          :schema $ :: 'Fn
            {} (:return 'Number)
              :args $ []
    ...
    'recollect.patch $ %{} 'FileEntry
      :defs $ {}
        ...
        'PatchPathSegment $ %{} 'CodeEntry (:doc |)
          ...
          :examples $ []
          :schema $ :: 'EnumDef
        'PatchResult $ %{} 'CodeEntry (:doc "|Nominal patch result carrying an open twig payload on success or a diagnostic PatchError.")
          :code $ quote
            defenum PatchResult (:ok 'Dynamic) (:err 'recollect.patch/PatchError)
          :examples $ []
          :schema $ :: 'Enum
              ...
              :code $ quote
                do
                  ...
                  let
                      ...
                      expected $ %:: PatchError :missing-node
    ...
    'recollect.wasm-test $ %{} 'FileEntry
      :defs $ {}
        ...
        'probe-tag-match $ %{} 'CodeEntry (:doc |)
          :code $ quote
            defn probe-tag-match () $ match (:: :map-splice 1 2)
              (:map-splice a b) (&+ a b)
              _ 0
          :examples $ []
          :schema $ :: 'Fn
